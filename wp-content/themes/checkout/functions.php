...
function checkout_setup() {
	 ...
	 */
	if( is_admin() ) {
		require_once( get_template_directory() . '/inc/admin/install.php' );
	}
...
function checkout_post_navs() {
	$nav_args = array(
	    'prev_text'          => '<div class="nav-text"><span>' . __( 'Previous', 'checkout' ) . ' <i class="fa fa-angle-right"></i></span> <h4>%title</h4></div>',
	    'next_text'          => '<div class="nav-text"><span><i class="fa fa-angle-left"></i> ' . __( 'Next', 'checkout' ) . '</span> <h4>%title</h4></div>',
 ...
 * @since checkout 1.0
 */
function checkout_filter_page_templates( $page_templates, $this, $post ) {
	...
	if( ! class_exists( 'EDD_Front_End_Submissions' ) ) :
		...
		unset( $page_templates['templates/template-vendor-dashboard.php'] );
	endif;
...
add_filter( 'theme_page_templates', 'checkout_filter_page_templates', 10, 3 );
