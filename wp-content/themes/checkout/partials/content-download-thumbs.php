...
<article itemscope itemtype="http://schema.org/Product" itemprop='productID' content='<?php the_ID(); ?>' id="post-<?php the_ID(); ?>" <?php post_class( 'post column portfolio-post equal edd_download' ); ?>>
